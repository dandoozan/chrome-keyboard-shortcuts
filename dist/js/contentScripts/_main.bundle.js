...
(async function main() {
  ...
  //input fields
  mousetrap__WEBPACK_IMPORTED_MODULE_0___default.a.stopCallback = function(e, element, combo) {
  ...
  let keyboardShortcuts = (await Object(_helpers_chrome__WEBPACK_IMPORTED_MODULE_2__["getContentScriptObject"])(window.location.href))
    .keyboard_shortcuts;
  keyboardShortcuts.forEach(({ keyCombo, fnName, args = [] }) => {
    Object(_common__WEBPACK_IMPORTED_MODULE_1__["registerKeyboardShortcut"])(keyCombo, () => actions[fnName](...args));
  });
})();
